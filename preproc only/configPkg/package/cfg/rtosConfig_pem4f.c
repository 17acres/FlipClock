...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[8093];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/Dan/Documents/GitHub/FlipClock/preproc only/configPkg/package/cfg/rtosConfig_pem4f");
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[1] = {
    {/* instance#0 */
        ...
        (xdc_UInt)0x0,  /* affinity */
        (xdc_runtime_Text_CordAddr)(xdc_runtime_Text_charTab__A+8018) /* __name */
    },
};
...
__FAR__ const CT__ti_uia_loggers_LoggerStopMode_Module__id ti_uia_loggers_LoggerStopMode_Module__id__C = (xdc_Bits16)0x802d;
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1f9d;
