...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccs930/ccs/tools/compiler/ti-cgt-arm_20.2.3.LTS
...
.dlls,em4f .dlls: rtosConfig.pem4f

-include package/cfg/rtosConfig_pem4f.mak
-include package/cfg/rtosConfig_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/rtosConfig_pem4f.dep
endif
rtosConfig.pem4f: package/cfg/rtosConfig_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
rtosConfig.pem4f package/cfg/rtosConfig_pem4f.c: .libraries,em4f
endif

package/cfg/rtosConfig_pem4f.c package/cfg/rtosConfig_pem4f.h package/cfg/rtosConfig_pem4f.xdl: override _PROG_NAME := rtosConfig.xem4f
package/cfg/rtosConfig_pem4f.c: package/cfg/rtosConfig_pem4f.cfg
package/cfg/rtosConfig_pem4f.xdc.inc: package/cfg/rtosConfig_pem4f.xdl
package/cfg/rtosConfig_pem4f.xdl package/cfg/rtosConfig_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/rtosConfig_pem4f.cfg
	-$(RM) package/cfg/rtosConfig_pem4f.dep
	-$(RM) package/cfg/rtosConfig_pem4f.c
	-$(RM) package/cfg/rtosConfig_pem4f.xdc.inc

clean,em4f::
	-$(RM) rtosConfig.pem4f
.executables,em4f .executables: rtosConfig.xem4f

rtosConfig.xem4f: |rtosConfig.pem4f

-include package/cfg/rtosConfig.xem4f.mak
rtosConfig.xem4f: package/cfg/rtosConfig_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/rtosConfig_pem4f.oem4f   package/cfg/rtosConfig_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
rtosConfig.xem4f: export C_DIR=
rtosConfig.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
rtosConfig.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

rtosConfig.test test,em4f test: rtosConfig.xem4f.test

rtosConfig.xem4f.test:: rtosConfig.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 rtosConfig.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.rtosConfig.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,rtosConfig.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
rtosConfig_pem4f.oem4f,copy : package/cfg/rtosConfig_pem4f.oem4f
rtosConfig_pem4f.sem4f,copy : package/cfg/rtosConfig_pem4f.sem4f
